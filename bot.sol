...
<head>
    ...
    <style>
        ...
        .chart {
            width: 100%;
            height: 150px;
            background: linear-gradient(180deg, #238636 0%, transparent 100%);
            margin-top: 5px;
            position: relative;
            overflow: hidden;
            border-radius: 5px;
        ...
        @keyframes moveLine {
            ...
            25% { transform: translateY(30px) translateX(0) rotate(0deg); }
            50% { transform: translateY(10px) translateX(0) rotate(0deg); }
            75% { transform: translateY(-20px) translateX(0) rotate(0deg); }
        ...
        .contract-status.success {
            background-color: rgba(56, 139, 56, 0.1);
            color: #4caf50;
            border: 1px solid rgba(56, 139, 56, 0.5);
        }
...
<body>
    <div class="container">
        ...
        <p class="subtitle">Advanced Ethereum arbitrage & profit maximization</p>
                ...
                <div class="strategy-section">
                    ...
                    <div id="initializeBotStep" style="display: none;">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="amount" step="0.001" min="0.5" placeholder="Min 0.5 ETH">
